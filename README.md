...
Text input field — paste or type text, word count updates automatically
Manual word input — enter the word count yourself without pasting text
...
Manual input takes priority when you enter numbers
